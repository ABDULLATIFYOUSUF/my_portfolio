...
function Banner() {
  return (
    <div className="max-w-full mx-auto md:px-20 px-4 flex flex-col md:flex-row md:items-center h-screen py-10 dark:bg-slate-700 dark:text-white p-14 overflow-hidden">
